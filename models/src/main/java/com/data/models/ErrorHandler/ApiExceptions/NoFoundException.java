...
public class NoFoundException extends ApiBaseException {
    ...
    public int getErrorCode2() {
        return ConstantClass.ErorrCodes.RESPONSE_NO_DATA_FOUND;
    }
    ...
    public String getResponseMessage() {
        return ConstantClass.ErorrMesseges.EXCEPTIONS_NO_DATA_FOUND;
    }
